  ...
  function (
    ...
    return {
      ...
      link: function postLink(scope, element) {
        ...
        scope.dropTextDefault         = 'Drop your files here (.wav/ pdf/ jpeg/ mp4/ json) or click to browse. You can drop a single file to annotate or a file + its _annot.json so it can get loaded along with its annotations';
